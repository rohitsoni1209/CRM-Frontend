                                    ...
                                    <div className="mt-2">
                                        <div className="w-full">
                                            <div className="my-4 w-full flex justify-between">
                                                <input onChange={handleChange} type='url' name='templateImage' className="bg-blue-50 w-full border rounded-md font-[200] focus:outline-none  p-3" placeholder="Template image url" />
                                            </div>
                                            <div className="my-4 w-full flex justify-between">
                                                <input onChange={handleChange} name='templateName' className="bg-blue-50 w-full border rounded-md font-[200] focus:outline-none  p-3" placeholder="Template name" />
                                            </div>
                                            <div className="my-4 w-full flex justify-between">
                                                <textarea rows={3} onChange={handleChange} name='message' className="bg-blue-50 w-full border rounded-md font-[200] focus:outline-none  p-2" placeholder="Message..." />
                                            </div>
