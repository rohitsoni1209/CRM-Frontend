...
const InovoiceList = (props) => {
  ...
  const tableHeader = useSelector((state) => state.Invoices.tableHeader) || [];
  ...
  useEffect(() => {
    ...
    dispatch(GET_ALL_DATA_FILTER_INVOICE({ offset: 1, limit: 10 }));
  }, [dispatch]);
  ...
  const handleShowRows = (value) => {
    setShowRows(value);
    dispatch(GET_ALL_DATA_INVOICE(currentPage, value));
  };
                ...
                <div className="flex justify-between items-center py-3">
                  ...
                  <div
                    ...
                    onClick={() => {
                      ...
                      navigate(
                        `/crm/canvas/view/${moduleName}?listingPath=/crm/invoices/invoices-canvas-list`
                      );
                    }}
