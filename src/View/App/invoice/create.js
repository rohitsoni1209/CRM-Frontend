...
export const CreateinvoiceOrder = (props) => {
...
// import { Plus } from "react-feather";
// import useAccessibleRole from "../../../hooks/useAccessibleRole";
// import { GET_FORM, GET_USER_PROFILE } from "../../../Redux/actions/user";
// import { list } from "../../../Components/module";
// import { useDispatch, useSelector } from "react-redux";
// import * as yup from "yup";
// import { GET_ALL_ACTIVE_USER } from "../../../Redux/actions/userList";
...
//     //  edit,
//     write,
//   } = useAccessibleRole("invoices" || "Invoices");
...
//   return <FormBuilder formType="Invoices" />;
// }
...
//     ?.split("?connectionId=")[1]
//     ?.split("?prePathname=");
//   const [formArrayData, setFormArrayData] = React.useState({
//     email: "",
//     people: [
//       {
//         id: Math.random(),
...
//   const generateYupSchema = (sections) => {
//     console.log("sec-tions-->", sections);
//     let schema = {};
//     let fields = {};
...
//     dispatch(GET_USER_PROFILE()).then((res) => {
//       if (res?.success) {
//         //   formik.setFieldValue("InvoiceOwnerId", res?.data?.data[0]?.userId);
//       }
//     });
//   }, []);
...
//             {console.log("values---isValid===>", values, touched, errors, isValid)}
//             <Field type="email" name="email" placeholder="Email" />
//             {/* <Field type={"text"} name={values?.subject} placeholder={values?.subject} /> */}
