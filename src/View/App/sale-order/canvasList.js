...
const CanvasSaleOrderList = (props) => {
                ...
                <div className="flex justify-between items-center py-3">
                  ...
                  <div
                    ...
                    onClick={() => {
                      ...
                      navigate(
                        `/crm/canvas/view/${moduleName}?listingPath=/crm/saleOrder/saleOrder-canvas-list`
                      );
                    }}
...
export default CanvasSaleOrderList;
