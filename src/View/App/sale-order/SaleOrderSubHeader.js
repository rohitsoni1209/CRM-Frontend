...
function SaleOrderSubHeader({ moduleName, setView }) {
                    ...
                    <Menu.Items>
                      ...
                      <Menu.Item className="text-gray-900 group flex w-full items-center px-5 py-[10px] text-sm border-b border-[#E4E4E7] hover:bg-primary hover:text-white">
                        {({ active }) => (
                          <Link
                            className={`${active && "bg-white"}`}
                            to="/crm/imports?module=saleOrders"
                          >
                            Import Sale Orders
                          </Link>
                        )}
                    ...
                    {deleteValue && (
                      <Menu.Item className="text-gray-900 group flex w-full items-center px-5 py-[10px] text-sm border-b border-[#E4E4E7] hover:bg-primary hover:text-white">
                        {({ active }) => (
                          <Link
                            className={`${active && "bg-white"}`}
                            to="/crm/saleorder/mass-module?type=delete"
                          >
                            Bulk Delete
                          </Link>
                        )}
                      ...
                      <>
                        <Menu.Item className="text-gray-900 group flex w-full items-center px-5 py-[10px] text-sm border-bottom b-[#E4E4E7] hover:bg-primary hover:text-white">
                          {({ active }) => (
                            <Link
                              className={`${active && "bg-white"}`}
                              to="/crm/saleorder/mass-module?type=update"
                            >
                              Bulk Update
                            </Link>
                          )}
                        ...
                        <Menu.Item className="text-gray-900 group flex w-full items-center px-5 py-[10px] text-sm border-bottom b-[#E4E4E7] hover:bg-primary hover:text-white">
                          {({ active }) => (
                            <Link
                              className={`${active && "bg-white"}`}
                              to="/crm/saleorder/mass-module?type=transfer"
                            >
                              Bulk Transfer
                            </Link>
                          )}
...
export default SaleOrderSubHeader;
