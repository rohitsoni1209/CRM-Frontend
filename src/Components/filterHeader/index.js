...
import SendEmailAndTask from "../sendEmailCreateTask";

const FilterHeader = ({ form, module, setView }) => {
  ...
  const selectedRows = usercheck?.Checbox?.selectRow?.selectedRows
  ...
  const {
    ...
    write,
    delete: deleteValue,
    excelSheet, autoResponders
  } = useAccessibleRole("contacts");
  ...
  return (
    <div className="bg-white py-3 -mx-8 group px-2">
      <div className="flex justify-between items-center px-8">
          ...
          {countCheck >= 1 ? (
            <>
              <div className="flex items-center gap-4">
                        ...
                        {macros.length && (
                          <Menu.Item className="text-gray-900 group flex w-full items-center px-5 py-[10px] text-sm border-b border-[#E4E4E7] hover:bg-primary hover:text-white">
                            {({ active }) => (
                              <Link
                                className={`${active && "bg-white"}`}
                                to={`/crm/macro/manage-macro?module=${module}`}
                              >
                                Manage Macro
                              </Link>
                            )}
                ...
                <SendEmailAndTask itemId={selectedItem?.selectedRows[0]?._id} moduleName={module} />
              </div>
            </>
          ) : (
            <>
        ...
        {selectedRows?.length === 1 && <Link role="button" to={`/crm/contacts-details/${selectedRows[0]?._id}`} className="cursor-pointer hidden group-hover:block">
          <DropdownEdit />
        </Link>}
        {!countCheck >= 1 && (
                ...
                <div className="absolute z-10 mt-1 w-max origin-top-right divide-y divide-gray-100 rounded-xl overflow-hidden bg-white shadow-lg focus:outline-none">
                  <Menu.Items>
                    <Menu.Item className="text-gray-900 group flex w-full items-center px-5 py-[10px] text-sm border-b border-[#E4E4E7] hover:bg-primary hover:text-white group">
                      {({ active }) => (
                        <button
                          onClick={() => setModuleView(`${module}-module-view`, 'list')}
                    ...
                    <Menu.Item className="text-gray-900 group flex w-full items-center px-5 py-[10px] text-sm border-bottom b-[#E4E4E7] hover:bg-primary hover:text-white">
                      {({ active }) => (
                        <button
                          onClick={() => setModuleView(`${module}-module-view`, 'Kanban')}
                          className={`flex items-center gap-2 ${active && "bg-white"}`}
                        >
                          <KanbanIcon />
                          Kanban View
                    ...
                    <Menu.Item className="text-gray-900 group flex w-full items-center px-5 py-[10px] text-sm border-bottom b-[#E4E4E7] hover:bg-primary hover:text-white">
                      {({ active }) => (
                        <button
                          onClick={() => setModuleView(`${module}-module-view`, 'canvas')}
                          className={`flex items-center gap-2 ${active && "bg-white"}`}
                        // to={canvasPath}
                        >
                          <CanvasIcon />
                  ...
                  <Menu>
                    ...
                    <div className="absolute z-10 right-0 mt-1 w-max origin-top-right divide-y divide-gray-100 rounded-md overflow-hidden bg-white shadow-lg focus:outline-none">
                      <Menu.Items>
                        {deleteValue && (
                          <Menu.Item className="text-gray-900 group flex w-full items-center px-5 py-[10px] text-sm border-b border-[#E4E4E7] hover:bg-primary hover:text-white">
                            {({ active }) => (
                              <Link
                                className={`${active && "bg-white"}`}
                                to="/crm/contacts/mass-module?type=delete"
                              >
                                Bulk Delete
                              </Link>
                            )}
                          ...
                          <>
                            <Menu.Item className="text-gray-900 group flex w-full items-center px-5 py-[10px] text-sm border-bottom b-[#E4E4E7] hover:bg-primary hover:text-white">
                              {({ active }) => (
                                <Link
                                  className={`${active && "bg-white"}`}
                                  to="/crm/contacts/mass-module?type=update"
                                >
                                  Bulk Update
                                </Link>
                              )}
                            ...
                            <Menu.Item className="text-gray-900 group flex w-full items-center px-5 py-[10px] text-sm border-bottom b-[#E4E4E7] hover:bg-primary hover:text-white">
                              {({ active }) => (
                                <Link
                                  className={`${active && "bg-white"}`}
                                  to="/crm/contacts/mass-module?type=transfer"
                                >
                                  Bulk Transfer
                                </Link>
                              )}
                        ...
                        {autoResponders && <Menu.Item className="text-gray-900 group flex w-full items-center px-5 py-[10px] text-sm border-b border-[#E4E4E7] hover:bg-primary hover:text-white">
                          {({ active }) => (
                            <Link
                              className={`${active && "bg-white"}`}
                              to="/crm/modules/auto-responders?module=Contacts"
                            >
                              Autoresponders
                            </Link>
                          )}
                        ...
                        {excelSheet && <Menu.Item className="text-gray-900 group flex w-full items-center px-5 py-[10px] text-sm border-bottom b-[#E4E4E7] hover:bg-primary hover:text-white">
                          {({ active }) => (
                            <NavLink
                              target="_blank"
                              className={`flex items-center gap-2 ${active && "bg-white"}`}
                              to={`/crm/sheetview?moduleName=${module}`}
                            >
                              XL Sheet View
                            </NavLink>
                          )}
